...
#define SCORE_LIVE_FOUR 35000  // 活四
#define SCORE_RUSH_FOUR 4900   // 冲四 (Block Four)
#define SCORE_LIVE_THREE 4900  // 活三
#define SCORE_SLEEP_THREE 700 // 眠三 (Block Three)
#define SCORE_LIVE_TWO 700    // 活二
#define SCORE_SLEEP_TWO 100    // 眠二
#define SCORE_LIVE_ONE 10      // 眠一/单子
