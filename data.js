...
const FLOOR_LAYOUTS = {
  4: {
    ...
    fixtures: [
      ...
      // 此路不通（右侧 456 旁，墙体向内收的位置）
      { type: 'blocked',  x: 615, y: 658, w: 75, h: 34, label: '此路不通' }
    ],
    // 外轮廓：上方城垛形（卫生间/426-434/432-434/卫生间 四组凸出）→ 右侧直墙 → 右下"此路不通"凹角 → 底部平缓斜边 → 左下斜边
    outline:
      'M 40,95 L 55,95 L 55,45 L 118,45 L 118,95 L 195,95 L 195,45 L 490,45 L 490,95 L 555,95 L 555,45 L 658,45 L 658,95 L 663,95 L 663,45 L 720,45 L 720,95 L 720,645 L 615,650 L 595,705 L 530,748 L 400,770 L 240,745 L 125,700 L 55,600 L 40,550 Z'
  },
