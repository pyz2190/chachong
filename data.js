...
const FLOOR_LAYOUTS = {
  4: {
    ...
    rooms: [
      ...
      // 底部一排（水平矩形沿斜墙阶梯下移）
      { id: '412', rect: [155, 580, 88, 55] },
      { id: '410', rect: [248, 612, 88, 55] },
      { id: '408', rect: [340, 642, 88, 55] },
      { id: '409', rect: [355, 555, 88, 52] },
      { id: '407', rect: [443, 612, 88, 55] }
    ],
    fixtures: [
      // 顶部两侧卫生间
      ...
      // 底部中部卫生间 + 楼梯（在 408 下方）
      { type: 'bathroom', x: 410, y: 715, w: 35, h: 30 },
      { type: 'stairs',   x: 452, y: 715, w: 42, h: 26 },
      // 此路不通（右侧 456 旁，墙体向内收的位置）
      { type: 'blocked',  x: 605, y: 652, w: 78, h: 36, label: '此路不通' }
    ],
    // 外轮廓：顶部水平 → 右侧 → 右下收口（此路不通处）→ 底部斜边 V 形 → 左下斜边 → 左侧
    outline:
      'M 40,40 L 720,40 L 720,560 L 700,615 L 700,650 L 600,648 L 580,720 L 510,758 L 410,780 L 290,768 L 170,728 L 80,620 L 40,560 Z'
  },
