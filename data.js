...
const FLOOR_LAYOUTS = {
  4: {
    ...
    rooms: [
      // 顶部一排（北侧凸出的房间）
      { id: '426', rect: [200, 55, 50, 38] },
      { id: '428', rect: [250, 55, 55, 38] },
      { id: '430', rect: [305, 55, 180, 38] },
      { id: '432', rect: [560, 55, 45, 38] },
      { id: '434', rect: [605, 55, 50, 38] },

      // 左侧第一列（418 / 416 / 414 同列对齐）
      { id: '418', rect: [70, 175, 95, 100] },
      { id: '416', rect: [70, 280, 95, 100] },
      { id: '414', rect: [70, 385, 95, 100] },

      // 左侧第二列（419 / 417 / 415 / 413 同列对齐）
      { id: '419', rect: [205, 175, 85, 100] },
      { id: '417', rect: [205, 280, 85, 100] },
      { id: '415', rect: [205, 385, 80, 60] },
      { id: '413', rect: [205, 450, 80, 55] },

      // 右侧内列（440-450）
      { id: '440', rect: [465, 175, 70, 55] },
      { id: '442', rect: [465, 233, 70, 50] },
      { id: '444', rect: [465, 286, 70, 50] },
      { id: '446', rect: [465, 339, 70, 48] },
      { id: '448', rect: [465, 390, 70, 55] },
      { id: '450', rect: [465, 448, 70, 60] },

      // 右侧外列（441-456）
      { id: '441', rect: [548, 175, 65, 105] },
      { id: '443', rect: [548, 285, 65, 60] },
      { id: '451', rect: [548, 350, 75, 50] },
      { id: '455', rect: [625, 405, 60, 55] },
      { id: '456', rect: [615, 465, 70, 90] },

      // 底部一排（水平矩形沿斜墙阶梯下移）
      { id: '412', rect: [125, 590, 88, 55] },
      { id: '410', rect: [218, 622, 88, 55] },
      { id: '408', rect: [310, 652, 88, 55] },
      { id: '409', rect: [478, 568, 88, 52] },
      { id: '407', rect: [478, 625, 88, 55] }
    ],
    fixtures: [
      // 顶部两侧卫生间（右侧由 x=660 调整到 665 以落入右上凸出墙体内）
      { type: 'bathroom', x: 65,  y: 55,  w: 50, h: 38 },
      { type: 'bathroom', x: 665, y: 55,  w: 50, h: 38 },
      // 左上电梯 / 楼梯
      { type: 'elevator', x: 75,  y: 113, w: 65, h: 38 },
      { type: 'stairs',   x: 213, y: 113, w: 60, h: 38 },
      // 左下楼梯（沿底部斜墙）
      { type: 'stairs',   x: 100, y: 510, w: 45, h: 26 },
      // 右侧中部卫生间（外列与内列之间）
      { type: 'bathroom', x: 575, y: 405, w: 35, h: 30 },
      // 底部中部卫生间 + 楼梯（在 408 与 407 之间）
      { type: 'bathroom', x: 408, y: 712, w: 35, h: 30 },
      { type: 'stairs',   x: 448, y: 712, w: 30, h: 26 }
    ],
    // 外轮廓：上方城垛形（卫生间/426-434/432-434/卫生间 四组凸出）→ 右侧直墙 → 右下平滑斜边 → 底部平缓斜边 → 左下斜边
    outline:
      'M 40,95 L 55,95 L 55,45 L 118,45 L 118,95 L 195,95 L 195,45 L 490,45 L 490,95 L 555,95 L 555,45 L 658,45 L 658,95 L 663,95 L 663,45 L 720,45 L 720,95 L 720,640 L 690,720 L 580,755 L 400,770 L 240,745 L 125,700 L 55,600 L 40,550 Z'
  },
  ...
  5: {
    ...
    fixtures: [
      ...
      { type: 'stairs',   x: 445, y: 615, w: 35, h: 26 },
      // 底部卫生间放到 508 下方的三角区域，避免与 508 多边形重叠
      { type: 'bathroom', x: 350, y: 720, w: 30, h: 22 }
    ],
    outline:
