...
/*
 * 楼层平面图坐标
 * - 4 楼：使用真实平面图截图作为底图 (image)，房间为透明覆盖层
 *         viewBox 与图片像素对应；坐标按原图像素估算
 * - 5 楼：仍采用纯 SVG 绘制
 */
const FLOOR_LAYOUTS = {
  4: {
    // 真实平面图底图（请把 image 文件放到 assets/floor-4.png）
    image: 'assets/floor-4.png',
    imageSize: { w: 780, h: 950 },
    viewBox: '0 0 780 950',
    rooms: [
      // 顶部一排（北侧凸出的房间）
      { id: '426', rect: [140,  45,  50, 55] },
      { id: '428', rect: [190,  45,  55, 55] },
      { id: '430', rect: [275,  50, 170, 60] },
      { id: '432', rect: [470,  45,  50, 55] },
      { id: '434', rect: [520,  45,  55, 55] },

      // 左外列（418 / 416 / 414）
      { id: '418', rect: [50,  195, 100, 110] },
      { id: '416', rect: [50,  310, 100, 110] },
      { id: '414', rect: [50,  430, 100, 115] },

      // 左内列（419 / 417 / 415 / 413）
      { id: '419', rect: [165, 175, 100, 135] },
      { id: '417', rect: [165, 315, 100, 105] },
      { id: '415', rect: [165, 422,  90,  50] },
      { id: '413', rect: [165, 472,  90,  55] },

      // 右内列（440-450，沿曲线下排）
      { id: '440', rect: [445, 170,  78,  60] },
      { id: '442', rect: [445, 225,  78,  55] },
      { id: '444', rect: [448, 278,  78,  55] },
      { id: '446', rect: [445, 330,  80,  55] },
      { id: '448', rect: [440, 380,  82,  55] },
      { id: '450', rect: [430, 450,  95,  65] },

      // 右外列（441-456）
      { id: '441', rect: [525, 195,  80, 105] },
      { id: '443', rect: [533, 295,  75,  60] },
      { id: '451', rect: [552, 358,  92,  52] },
      { id: '455', rect: [650, 425,  65,  55] },
      { id: '456', rect: [625, 495,  75,  90] },

      // 底部左侧斜排（412 / 410 / 408）
      { id: '412', rect: [115, 600,  95,  65] },
      { id: '410', rect: [205, 645,  95,  65] },
      { id: '408', rect: [298, 690,  95,  65] },

      // 底部中间（409 / 407）
      { id: '409', rect: [465, 575,  95,  60] },
      { id: '407', rect: [465, 635,  95,  65] }
    ],
    // 底图已自带卫生间 / 楼梯 / 电梯 / 此路不通 等图标，无需再渲染 fixtures
    fixtures: []
  },
